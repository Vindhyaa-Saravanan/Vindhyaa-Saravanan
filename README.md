### Ready to build a future where technology meets impact, and AI transforms the way we live, work, and thrive. 💙
...
## About Me 🧠💡
- 🎓 MEng, BSc Computer Science @ The University of Leeds, on track for a First-Class Honors track (2021-2025).
- 🌍 Interest in cloud computing, artificial intelligence, machine learning, and cybersecurity, using technology to impact people's daily lives. Great personal interest in computational medicine and biomedical AI applications for improving healthcare and health literacy.
- 💼 Interned at Schneider Electric and AVEVA, where I worked on integrating complex cybersecurity solutions, visualizing team progress, and addressing key infrastructure challenges.
...
[![My Skills](https://skillicons.dev/icons?i=py,java,html,css,js,c,tensorflow,flask,django,github,visualstudio,nodejs,nextjs,react,aws,azure)](https://skillicons.dev)

## Professional Experience 🌍🛠️

#### Process Automation Summer Intern  
Schneider Electric Systems Middle East | June 2024 – August 2024
...
## 🤝 If you’re working on an innovative project, know of an opportunity I can contribute to, or just want to chat about how tech can improve our daily lives, let’s connect!
